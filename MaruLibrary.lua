...
Closed.Image = "rbxassetid://16108225957"
...
---------------------------------------------------------------------------Create Tab
local SOMEXHUB = library:AddWindow("MaruLibrary",Enum.KeyCode.RightControl)
local Main = SOMEXHUB:AddTab("Chính","16108225957")
local Sea = SOMEXHUB:AddTab("Sự Kiện Biển","16108225957")
local M = SOMEXHUB:AddTab("Vật Phẩm","16108225957")
local Ss = SOMEXHUB:AddTab("Chỉ Số","16108225957")
local RaceV4 = SOMEXHUB:AddTab("Tộc V4","16108225957")
local P = SOMEXHUB:AddTab("Người chơi","16108225957")
local R = SOMEXHUB:AddTab("Tập Kích","16108225957")
local T = SOMEXHUB:AddTab("Di Chuyển","16108225957")
local S = SOMEXHUB:AddTab("Cửa Hàng","16108225957")
local D = SOMEXHUB:AddTab("Trái Ác Quỷ","16108225957")
local Misc = SOMEXHUB:AddTab("Khác","16108225957")
---------------------------------------------------------------------------
spawn(function()
    game:GetService("RunService").Heartbeat:Connect(function()
