	...
	function getBlueGear()
		if game.workspace.Map:FindFirstChild("MysticIsland") then
			for r, v in pairs(game.workspace.Map.MysticIsland:GetChildren()) do
				if v:IsA("MeshPart") and v.MeshId == "rbxassetid://16108225957" then
					return v
				end
			end
		end
	...
	function getHighestPoint()
		...
		for r, v in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
			if v:IsA("MeshPart") then
				if v.MeshId == "rbxassetid://16108225957" then
					return v
				end
			end
		end
...
local Window = OrionLib:MakeWindow({Name = "MaruLibrary", HidePremium = false, IntroText = "Maru Library", SaveConfig = true, ConfigFolder = "Maru Hub"})
----------Tab-----------------------
        ...
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "Maru Hub Library(Noitification)",
                    Content = "[EN] : Please cancel the farrm level quest (if any)",
                    Image = "rbxassetid://16108225957",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "Maru Hub Library(Noitification)",
