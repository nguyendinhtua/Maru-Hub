...
end)local c= e:Window("Maru Hub","11354741327")local e= c:Tab("Main","rbxassetid://16108225957")local f= c:Tab("Main 2","rbxassetid://16108225957")local g= c:Tab("Player/Stats","rbxassetid://16108225957")local h= c:Tab("Combat","rbxassetid://16108225957")local i= c:Tab("Teleport/Sv","rbxassetid://16108225957")local j= c:Tab("Raid","rbxassetid://16108225957")local k= c:Tab("Devil Fruit","rbxassetid://16108225957")local l= c:Tab("Shop","rbxassetid://16108225957")local c= c:Tab("Misc","rbxassetid://16108225957")e:Seperator("Settings")e:Button("Copy Link Discord Server",function()
end)e:Label("//Welcome To Maru Hub//")DateTime= e:Label(" ")function UpdateOS()local a= os.date("*t")local b= (a.hour)%24;local c=b<12 and"AM"or"PM"local b= string.format("%02i:%02i:%02i %s", ((b -1) % 12) + 1, a.min, a.sec, c)local a= string.format("%02d/%02d/%04d", a.day, a.month, a.year)local c= game:GetService("LocalizationService")local e= game:GetService("Players")local e= e.LocalPlayer;local f= e.Name;local c,c= pcall(function()
