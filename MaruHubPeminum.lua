...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Maru Hub chào ae<Color=/>"):Display()
    wait(.5)
...
local Window = OrionLib:MakeWindow({Name = "Maru Hub", HidePremium = false, IntroText = "Maru Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("Maru Hub SCRIPT")
W:AddLabel("DiscordMaru Hub")
local Section = W:AddSection({
    Name = "Status"
})
