...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>MaruHubPeminum chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Black>Loading Script MaruHubPreminum"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "MaruHubPeminum", HidePremium = false, IntroText = "MaruHubPeminum⚜️", SaveConfig = true, ConfigFolder = "NightHub"})



OrionLib:MakeNotification({
    Name = "MaruHubPeminum",
    Content = "by Nguyễn Đình Tuấn",
    Image = "rbxassetid://16108225929",
    Time = 5
})
wait(3)
OrionLib:MakeNotification({
...
W:AddLabel("MaruHubPeminum SCRIPT")
W:AddLabel("DiscordMaruHubPeminum")
local Section = W:AddSection({
    Name = "Status"
})
    ...
    while wait(.1) do
        if _G.FastAttackDelay then
            pcall(function()
                ...
                elseif _G.FastAttackDelay == "0.00" then
                    _G.FastAttackDelay = 0.00
...
pcall(function()
    while wait() do
        if _G.AutoEliteHunter then
            if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == true then
                OrionLib:MakeNotification({
                    Name = "MaruHubPeminum(Noitification)",
                    Content = "Script Mobile&Pc",
                    Image = "rbxassetid://16108225929",
                    Time = 9
                })
                OrionLib:MakeNotification({
                    Name = "MaruHubPeminum(Noitification)",
                    Content = "[VN] Script MaruHubPreminum",
                    Image = "rbxassetid://16108225929",
                    Time = 9
                })
            end
        ...
        while wait() do
            if _G.AutoObservation then
                if game:GetService("Players").LocalPlayer.VisionRadius.Value >= 3000 then
                    OrionLib:MakeNotification({
                        Name = "MaruHubPeminum BOT",
                        Content = "Script có 2 bản",
...
OrionLib:MakeNotification({
        Name = "MaruHubPeminum",
        Content = "Loading Script MaruHubPeminum",
        Image = "rbxassetid://16108225929",
        Time = 5
    })
...
OrionLib:MakeNotification({
    Name = "MaruHubPeminum",
    Content = "Loading MaruHubPeminum",
    Image = "rbxassetid://16108225929",
    Time = 5
})