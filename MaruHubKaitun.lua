...
ImageButton1.Image = "rbxassetid://16108225957"
...
if game:GetService("CoreGui"):FindFirstChild("MaruHubKaitun") then
    game:GetService("CoreGui"):FindFirstChild("MaruHubKaitun"):Destroy()
end
...
function Update:Window(text,logo,keybind)
    ...
    MARUHUB.Name = "MaruHubKaitun"
    MARUHUB.Parent = game.CoreGui
    MARUHUB.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

    local Main = Instance.new("Frame")
    Main.Name = "Main"
    Main.Parent = MARUHUBKAITUN
	...
	Logo.Image = "rbxassetid://16108225957"
    ...
    function uitab:AddTab(text,img)
        ...
        IDK.Image = "rbxassetid://16108225957" .. tostring(img)
...
Main:AddToggle("Farm Chest Stop Torch",_G.STP,function(vu)
	Grab_Chest = vu
...
M:AddToggle('Kill Sea baeat Hop', false, function(value)
...
spawn(function()
 ...
 RaceV4:AddButton("Complete Angel Trial",function(t)
    ...
    spawn(function()
		while wait() do
			if _G.AutoPlayerHunter and World3 then
				if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					repeat 
						topos(CFrame.new(-5560.00390625, 313.74130249023, -2838.4792480469)) 
						wait() 
	...
	spawn(function()
		while wait() do
			if _G.AutoPlayerHunter and World1 then
				if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					repeat 
						topos(CFrame.new(972.4349975585938, 16.27355194091797, 1412.172607421875)) 
						wait() 
	...
	spawn(function()
		while wait() do
			if _G.AutoPlayerHunter and World2 then
				if game:GetService("Players").LocalPlayer.PlayerGui.Main.Quest.Visible == false then
					repeat 
						topos(CFrame.new(-375.8029479980469, 73.36331939697266, 351.3997497558594)) 
						wait() 
    ...
    P:AddToggle("Farm Bounty",_G.AutoFarmBounty,function(value)
    ...
    P:AddToggle("Farm Bounty Hop",_G.AutoFarmBounty_Hop,function(value)
...
Misc:AddButton("Kaitun Cap", function(value)
		...
		for k,v in pairs(cac) do
			if ListHuhu[v] and game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Buy"..v,true) == 1 then 
				...
				huhu.Image = "rbxassetid://16108225957"
