...
LogoHub.Image = "http://www.roblox.com/asset/?id="..tostring(13717478897)
...
function uitab:Tab(text,image)
    ...
    TabButton.TextTransparency = 0.500
        ...
        PageImage.Image = "rbxassetid://16108225957"..tostring(Image)
...
LogoToggle.Image = "http://www.roblox.com/asset/?id="..tostring(13717478897)
    ...
    function main:Dropdown(text,option,callback)
        ...
        DropImage.Image = "rbxassetid://16108225957"
...
local Library = Update:Window("Maru Hub X Preminum","2.0",Enum.KeyCode.RightControl);

Main = Library:Tab("Chính",16108225957)
Sta = Library:Tab("Chỉ số",16108225957)
Miscf = Library:Tab("Vật phẩm",16108225957)
Sho = Library:Tab("Trái Ác Quỷ",16108225957)
Shop = Library:Tab("Cửa hàng",16108225957)
Raid = Library:Tab("Tập Kích",9606629300)
TPKub = Library:Tab("Di chuyển",16108225957)
Py = Library:Tab("Người chơi",16108225957)
-------------------------------------------------------------

Main:Toggle("Cày Cấp",_G.Setting_table.AutoFarm,function(vu)
Auto_Farm = vu
Auto_Fast_Farm = vu
...
Main:Toggle("Cày 600 thông thạo melee",_G.Setting_table.MasMelee,function(vu)
MasMelee = vu
...
Main:Seperator("Qua Sea2")

Main:Toggle("Tự động qua sea2",_G.Setting_table.MasMelee,function(vu)
Auto_New_A = vu
...
Main:Toggle("Tự động qua sea3",false,function(vu)
Auto_Three_World = vu
end)
...
Main:Dropdown("Chọn vũ khí", Waspon,function(vu)
_G.Setting_table.SelectWeapon = vu
Update_Setting(getgenv()['MyName'])
end)

Main:Toggle("Gom quái",true,function(vu)
...
Main:Dropdown("Chọn chế độ",fast,function(vu)
...
Main:Dropdown("Chọn thời gian đánh nhanh",SFast,function(vu)
_G.Setting_table.FastModeD = vu
Update_Setting(getgenv()['MyName'])
end)

Main:Toggle("Nhận 2 lần nv khi farm ",_G.Setting_table.DbQ,function(vu)
DbQ = vu
_G.Setting_table.DbQ = vu
Update_Setting(getgenv()['MyName'])
end)

Main:Toggle("Đánh Nhanh ",true,function(vu)
Fast_Attack = vu
_G.Setting_table.Fast_Attack = vu
Update_Setting(getgenv()['MyName'])
end)

Main:Toggle("Đánh nhanh x2",_G.Setting_table.DbFast,function(vu)
DbFast = vu
_G.Setting_table.DbFast = vu
Update_Setting(getgenv()['MyName'])
end)

Main:Toggle("Ẩn Dame Đánh Quái",_G.Setting_table.KobenHeegeen,function(vu)
KobenHeegeen = vu
...
Main:Toggle("Ẩn Tất Cả Thông Báo",_G.Setting_table.Refec,function(vu)
Refec = vu
...
Main:Toggle(" Xóa hiệu ứng quái chết ",_G.Setting_table.Refec,function(vu)
Remove_Effect = vu
...
Main:Toggle(" Xóa nhạc ",_G.Setting_table.Refec,function(vu)
RemoveHit = vu
...
Main:Toggle(" Bật haki ",_G.Setting_table.Auto_Buso,function(vu)
Auto_Buso = vu
...
Main:Toggle(" Bật haki quan sát ",_G.Setting_table.AutoKen,function(vu)
...
Main:Toggle(" Màn hình đen ",_G.Setting_table.StartBlackScreen,function(vu)
...
Main:Toggle("Ẩn quái",_G.Setting_table.inv,function(value)
...
Main:Toggle(" Nhập code ",_G.Setting_table.Auto_Redeem_All_Code,function(vu)
...
Main:Seperator("Cày quái")

Main:Toggle("Cày quái chọn",_G.Setting_table.Auto_Farm_Monster,function(vu)
...
Main:Dropdown("Chọn quái",tableMon,function(vu)
...
Main:Toggle("Nhặt rương",_G.Setting_table.Grab_Chest,function(vu)
Grab_Chest = vu
...
Main:Toggle("Nhặt rương đảo bí ẩn",_G.Setting_table.AutoChestMirage,function(vu)
...
spawn(function()
    pcall(function()
        while wait() do
            Bone:Set("    // Số lượng xương : "..tostring(game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Bones","Check").." \\\\"))
        end
    end)
end)

Main:Toggle("Cày xương",_G.Setting_table.Farm_Bone,function(vu)
    Auto_Farm_Bone = vu
...
Main:Toggle("Đổi xương",_G.Setting_table.Farm_Random_S,function(vu)
    Farm_Random_S = vu
...
Main:Toggle("Cày katakuri",_G.Setting_table.Auto_Spikey_Trident,function(vu)
...
Main:Toggle("Cày katakuri v2",_G.Setting_table.Prince2,function(vu)
    Prince2 = vu
                                ...
                                function HopServer()
                                    if not _G.TP_Ser then
                                        ...
                                        game.StarterGui:SetCore("SendNotification", {
                                            Title = "Hop Low Server ", 
                                            Text = "กำลังหาเซิฟ",
                                            Icon = "http://www.roblox.com/asset/?id=16108225957",
                                            Duration = 25
                                        })
                                        local PlaceID = game.PlaceId
                                        local AllIDs = {}
...
Main:Toggle("Cày thông thạo trái",_G.Setting_table.Farm_Fruit,function(vu)
    Auto_Farm_Fruit = vu
...
MinHealth = 20
Main:Slider("Máu Quái %",1,100,20,function(vu)
    MinHealth = vu
    _G.Setting_table.MinHealth = vu
    Update_Setting(getgenv()['MyName'])
end)

Main:Slider("Khoảng Cách",1,5000,1000,function(vu)
...
Miscf:Toggle("Tp đến đảo kì bí",_G.Setting_table.AutoMysticIsland,function(vu)
...
Miscf:Button("Tp đến Npc bán trái",function()
...
Miscf:Toggle("Tp đến bánh răng",_G.Setting_table.TeleporttoGear,function(vu)
...
Miscf:Toggle("Tìm trăng tròn",_G.Setting_table.AutoFindFullmoon,function(vu)
...
while task.wait() do
    pcall(function()
        ddiss:Set("Khoảng Cách | ".._G.Setting_table.DistanceMobAura)
    end)
end
end)

Miscf:Toggle("Đánh Quai Gần",_G.Setting_table.Mob_Aura,function(vu)
AutoMobAura = vu 
_G.Setting_table.Mob_Aura = vu
Update_Setting(getgenv()['MyName'])
end)

Miscf:Slider("Phạm Vi Đánh",1,5000,1000,function(vu)
DistanceMobAura = vu
...
Miscf:Toggle("Đánh Boss",_G.Setting_table.AutoFarmBoss,function(vu)
_G.Setting_table.AutoFarmBoss = vu
Update_Setting(getgenv()['MyName'])
end)


Miscf:Toggle("Đánh hết Boss",_G.Setting_table.AutoFarmAllBoss,function(vu)
...
Miscf:Toggle("Nhận Nhiệm Vụ Boss",_G.Setting_table.AutoQuestBoss,function(vu)
...
Miscf:Dropdown("Chọn Boss",tableBoss,function(a)
_G.Setting_table.Selectb = a
Update_Setting(getgenv()['MyName'])
end)

Sta:Seperator("Nâng chỉ số")
...
Sta:Toggle("Máu",_G.Setting_table.Defense_A,function(vu)
Defense_A = vu
_G.Setting_table.Defense_A = vu
Update_Setting(getgenv()['MyName'])
end)
Sta:Toggle("Kiếm",_G.Setting_table.Sword_A,function(vu)
Sword_A = vu
_G.Setting_table.Sword_A = vu
Update_Setting(getgenv()['MyName'])
end)
Sta:Toggle("Trái",_G.Setting_table.Fruit_A,function(vu)
Fruit_A = vu
_G.Setting_table.Fruit_A = vu
Update_Setting(getgenv()['MyName'])
end)
Sta:Toggle("Súng",_G.Setting_table.Gun_A,function(vu)
Gun_A = vu
_G.Setting_table.Gun_A = vu
Update_Setting(getgenv()['MyName'])
end)
Sta:Slider("Điểm",1,100,3,function(vu)
Points = vu
end)
...
Miscf:Toggle("Lấy Acidum Rifle",_G.Setting_table.Auto_Acidum_Rifle,function(vu)
...
Miscf:Seperator("// Lấy Cận Chiến \\\\\ ")

Miscf:Toggle(" Superhuman",_G.Setting_table.Superhuman,function(vu)
_G.Setting_table.Superhuman = vu
Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle(" Death Step",_G.Setting_table.Death_Step,function(vu)
_G.Setting_table.Death_Step = vu

Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle(" Sharkman Karate",_G.Setting_table.Sharkman_Karate,function(vu)
_G.Setting_table.Sharkman_Karate = vu

Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle(" Electric Claw",_G.Setting_table.Electric_Claw,function(vu)
_G.Setting_table.Electric_Claw = vu

Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle(" Dragon Talon",_G.Setting_table.Dragon_Talon,function(vu)
_G.Setting_table.Dragon_Talon = vu

Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle("God Human",_G.Setting_table.Auto_God_Human,function(vu)
...
Miscf:Seperator("Nguyên liệu")

local SelectMaterial = Miscf:Dropdown("Chọn nguyên liệu",MaterialMethod,function(vu)
_G.SelectMaterial = vu
end)

Miscf:Toggle("Cày nguyên liệu",_G.Setting_table.AutoFarm_Meterial,function(vu)
...
Miscf:Seperator("// Boss bí ẩn \\\\\ ")

Miscf:Toggle("Cày boss bí ẩn",_G.Setting_table.Auto_Elite_Hunter,function(vu)
            ...
            if not Mix_Farm or Auto_Elite_Hunter_Farm then
                ...
                elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") or game:GetService("Workspace").Enemies:FindFirstChild("Deandre") then
                    ...
                    elseif game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") then
                        TP(game:GetService("ReplicatedStorage"):FindFirstChild("Deandre").HumanoidRootPart.CFrame*CFrame.new(0,30,0))
                    end
                elseif _G.Setting_table.Auto_Elite_Hunter_Hop then
                    wait(5)
                    if not game:GetService("ReplicatedStorage"):FindFirstChild("Urban") and not game:GetService("Workspace").Enemies:FindFirstChild("Urban") and not game:GetService("ReplicatedStorage"):FindFirstChild("Diablo") and not game:GetService("Workspace").Enemies:FindFirstChild("Diablo") and not game:GetService("ReplicatedStorage"):FindFirstChild("Deandre") and not game:GetService("Workspace").Enemies:FindFirstChild("Deandre") then
                        HopServer()
                        wait(50)
                    end
...
Miscf:Toggle("LấyPole V1",_G.Setting_table.Pole_Farm,function(vu)
Pole_Farm = vu
...
Miscf:Toggle("Lấy Serpent Bow",_G.Setting_table.Auto_Serpent_Bow,function(vu)
Auto_Serpent_Bow = vu
...
Miscf:Toggle("Lấy Dragon Trident",_G.Setting_table.Auto_Dragon_Trident,function(vu)
...
Miscf:Toggle("Lấy Swan Glass",_G.Setting_table.Auto_Swan_Glass,function(vu)
Auto_Swan_Glass = vu
...
Miscf:Toggle("Lấy Buddy Sword",_G.Setting_table.Auto_Buddy_Sword,function(vu)
Auto_Buddy_Sword = vu
...
Miscf:Seperator("// Valkyrie Helmet \\\\\ ")

Miscf:Toggle("Lấy Valkyrie Helmet",_G.Setting_table.Auto_Valkyrie_Helmet,function(vu)
...
local BC = Miscf:Dropdown("Chọn thuyền",BN,function(plys)
BoatLis = plys
end)

Miscf:Button("Làm mới",function()
BN = {}
BC:Clear()
for i,v in pairs(game:GetService("Workspace").Boats:GetChildren()) do  
 BC:Add(v.Name)
...
Miscf:Toggle("Lái thuyền", _G.Setting_table.AutoRougthFully,function(vu)
     AutoRougthFully = vu
...
Miscf:Toggle("Đánh Terrorshark", _G.Setting_table.AutoTerrorshark,function(vu)
     AutoTerrorshark = vu
     _G.Setting_table.AutoTerrorshark = vu
     Update_Setting(getgenv()['MyName'])
end)

Miscf:Toggle("Đánh Shark", _G.Setting_table.FarmShark,function(vu)
     FarmShark = vu
...
Miscf:Toggle("Đánh Piranha", _G.Setting_table.FarmPiranha,function(vu)
     FarmPiranha = vu
...
Miscf:Toggle('đánh thủy quái',_G.Setting_table.AutoSeaBest, function(vu)
AutoSeaBest = vu
...
Miscf:Toggle("Lấy Saber",_G.Setting_table.Saber_Farm,function(vu)
Saber_Farm = vu
...
Miscf:Toggle("Đánh hải tặc pháo đài",_G.Setting_table.Auto_Quest_Tushita_2,function(vu)
...
Miscf:Toggle("Lấy Tushita",_G.Setting_table.Auto_Tushita,function(vu)
Auto_Tushita = vu
                ...
                if not _G.Setting_table.Quest_Torch then
                    ...
                    if game.Workspace.Enemies:FindFirstChild("Longma") or game.ReplicatedStorage:FindFirstChild("Longma") then
                        ...
                        elseif game.ReplicatedStorage:FindFirstChild("Longma") then
                            TP(game.ReplicatedStorage:FindFirstChild("Longma").HumanoidRootPart.CFrame*CFrame.new(0,30,0))
                        end
                    elseif Auto_Tushita_Farm then
                        Auto_Tushita_Farm = nil
                        Mix_Farm = nil
...
Miscf:Toggle("Lấy Twin Hooks",_G.Setting_table.Auto_Twin_Hooks,function(vu)
Auto_Twin_Hooks = vu
        ...
        if Auto_Twin_Hooks then
            if not Mix_Farm or Auto_Twin_Hooks_Farm then
                ...
                elseif _G.Setting_table.Auto_Twin_Hooks_Hop then
                    wait(5)
                    if not game.Workspace.Enemies:FindFirstChild("Captain Elephant") and not game.ReplicatedStorage:FindFirstChild("Captain Elephant") then
                        HopServer()
                        wait(50)
                    end
...
Miscf:Toggle("Lấy Canvander",_G.Setting_table.Auto_Canvander,function(vu)
Auto_Canvander = vu
        ...
        if Auto_Canvander then
            if not Mix_Farm or Auto_Canvander_Farm then
                if game.Workspace.Enemies:FindFirstChild("Beautiful Pirate") or game.ReplicatedStorage:FindFirstChild("Beautiful Pirate") then
                    ...
                    elseif game.ReplicatedStorage:FindFirstChild("Beautiful Pirate") then
                        TP(game.ReplicatedStorage:FindFirstChild("Beautiful Pirate").HumanoidRootPart.CFrame*CFrame.new(0,30,0))
                    end
                elseif _G.Setting_table.Auto_Canvander_Hop then
                    wait(5)
                    if not game.Workspace.Enemies:FindFirstChild("Beautiful Pirate") and not game.ReplicatedStorage:FindFirstChild("Beautiful Pirate") then
                        HopServer()
                        wait(50)
                    end
...
Miscf:Toggle("Lấy Hallow Scythe",_G.Setting_table.Auto_Hallow_Scryte,function(vu)
    ...
    pcall(function()
        if Auto_Hallow_Scryte then
            ...
            elseif game.Players.LocalPlayer.Character:FindFirstChild("Hallow Essence") or game.Players.LocalPlayer.Backpack:FindFirstChild("Hallow Essence") then
                ...
                until not game.Players.LocalPlayer.Character:FindFirstChild("Hallow Essence") and not game.Players.LocalPlayer.Backpack:FindFirstChild("Hallow Essence") or game.Workspace.Enemies:FindFirstChild("Soul Reaper") or game.ReplicatedStorage:FindFirstChild("Soul Reaper") 
            elseif _G.Setting_table.Hallow_Scryte_Hop then
                wait(5)
                if not game.Workspace.Enemies:FindFirstChild("Soul Reaper") and not game.ReplicatedStorage:FindFirstChild("Soul Reaper") then
                    HopServer()
                    wait(50)
                end
            else
                ...
                elseif game.ReplicatedStorage:FindFirstChild("Reborn Skeleton") then
                    TP(game.ReplicatedStorage:FindFirstChild("Reborn Skeleton").HumanoidRootPart.CFrame*CFrame.new(0,30,0))
                end
            end
        else
            wait(2)
...
Miscf:Toggle("Lấy Dark Dagger",_G.Setting_table.Auto_Dark_Dagger,function(vu)
Auto_Dark_Dagger = vu
...
Miscf:Seperator("// Kiếm Huyền Thoại \\\\\ ")
...
pcall(function()
    while wait() do
        ...
        elseif game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("LegendarySwordDealer","3") then
            ...
            LegendSwords:Set("Không Có Npc Bán kiếm")
        end
    end
end)
end)
...
Miscf:Toggle("Mua kiếm huyền thoại",_G.Setting_table.AutoBuyLegendarySword,function(vu)
...
pcall(function()
    while wait() do
        if game:GetService("ReplicatedStorage"):WaitForChild("Remotes"):WaitForChild("CommF_"):InvokeServer("ColorsDealer", "1") then
            ...
            ColorHaki:Set("Không Có Npc bán haki")
        end
    end
end)
end)
...
Miscf:Toggle("Mua haki màu",_G.Setting_table.AutoBuyEnchancementColour,function(vu)
...
Miscf:Seperator("// Up tộc v2 \\\\\ ")

Miscf:Toggle("Lấy Mink v2",_G.Setting_table.Mink_Evo,function(vu)
_G.Setting_table.Mink_Evo = vu
Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle("Lấy Human v2",_G.Setting_table.Human_Evo,function(vu)
_G.Setting_table.Human_Evo = vu
Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle("Lấy Skypiea v2 ",_G.Setting_table.Skypiea_Evo,function(vu)
_G.Setting_table.Skypiea_Evo = vu
Update_Setting(getgenv()['MyName'])
end)
Miscf:Toggle("Lấy Fish v2 ",_G.Setting_table.Fishman_Evo,function(vu)
...
Miscf:Toggle("Cày Tam Kiếm Zoro",_G.Setting_table.Triple_A,function(vu)
Auto_Farm_Sword = vu
Triple_A = vu
...
Miscf:Toggle("Lấy kiếm yama",_G.Setting_table.AutoYama,function(vu)
...
Miscf:Toggle("Mở haki đánh boss rip_indra",Open_Color_Haki,function(vu)
Open_Color_Haki = vu
...
Miscf:Toggle("Thắp đuốc Tushita",_G.Setting_table.Auto_Holy_Torch,function(vu)
Auto_Holy_Torch = vu
...
spawn(function()
    while game:GetService("RunService").Heartbeat:wait() do
        ...
        ObservationLevel:Set("Điểm haki quan sát : "..tostring(Lpp))
    end
end)
...
Miscf:Toggle("Cày điểm haki quan sát",_G.Setting_table.Farm_Ken,function(vu)
Farm_Ken = vu
_G.Setting_table.Farm_Ken = vu
Update_Setting(getgenv()['MyName'])
end)

Miscf:Toggle("Lấy haki quan sát v2",_G.Setting_table.Farm_Ken_V2,function(vu)
Farm_Ken = vu
Farm_Ken_V2 = vu
...
Miscf:Toggle("Lấy Rainbow Haki",_G.Setting_table.Auto_Rainbow_Haki,function(vu)
...
Miscf:Toggle("Lấy Rengoku",_G.Setting_table.AutoRengoku,function(vu)
...
Miscf:Toggle("Cày vật chất kì dị",_G.Setting_table.AutoEctoplasm,function(vu)
...
Miscf:Toggle("Làm Nv Bartlio",_G.Setting_table.Bartlio_Farm,function(vu)
Bartlio_Farm = vu
...
Miscf:Toggle("Lấy Swan Glass",_G.Setting_table.Open_Don_Swan,function(vu)
Inventory_Fruit = vu
BringFruit = vu
Don_Swan_Quest = vu
...
Sho:Button("Cửa hàng trái",function()
game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
end)

Sho:Toggle("Đổi trái",_G.Setting_table.Auto_Random_Fruit,function(vu)
...
Sho:Toggle("Gom trái",_G.Setting_table.BringFruit,function(vu)
BringFruit = vu
...
Sho:Toggle("Cất Trái",_G.Setting_table.Auto_Store_Fruit,function(vu)
    ...
    if _G.Setting_table.Auto_Store_Fruit then
        for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do
            if string.find(v.Name,"Fruit") and not UseThireWorld then
                ...
                if v.Name == "Falcon Fruit" then
                    NameFruit = "Falcon"
                elseif v.Name == "Phoenix Fruit" then
                    NameFruit = "Phoenix"
                elseif v.Name == "Buddha Fruit" then
                    NameFruit = "Buddha"
                else
...
Shop:Button("hoàn trả chỉ số",function()
...
Raid:Toggle("Tự động raid",_G.Setting_table.Auto_Raid,function(vu)
Auto_Raid = vu
_G.Setting_table.Auto_Raid = vu
Update_Setting(getgenv()['MyName'])
end)

Raid:Toggle("Nâng V2",_G.Setting_table.Auto_Awaken,function(vu)
...
Raid:Dropdown("Chọn Raid",Map,function(vu)
...
Raid:Toggle("Lấy Trái ít bely",_G.Setting_table.Get_Fruit,function(vu)
...
Raid:Toggle("Mua + đánh law",_G.Setting_table.Raw,function(vu)
    Auto_Raw = vu
...
Raid:Toggle("Esp Người chơi",_G.Setting_table.ESPPlayer,function(vu)
ESPPlayer = vu
_G.Setting_table.ESPPlayer = vu
UpdatePlayerChams()
end)

Raid:Toggle("Esp Rương",_G.Setting_table.ChestESP,function(vu)
ChestESP = vu
_G.Setting_table.ChestESP = vu
UpdateChestChams()
end)

Raid:Toggle("ESP đảo",_G.Setting_table.Islandesp,function(vu)
Islandesp = vu
...
Raid:Toggle("ESP trái ác quỷ",_G.Setting_table.DevilFruitESP,function(vu)
DevilFruitESP = vu
...
TPKub:Seperator("Thế giới")

TPKub:Button("Sea 1",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
end)


TPKub:Button("Sea 2",function()
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
end)

TPKub:Button("Sea 3",function()
...
TPKub:Seperator("Di chuyển")

TPKub:Dropdown("Chọn đảo",Island,function(vu)
_G.Select_Island = vu
_G.Setting_table.Select_Island = vu
end)

TPKub:Button("Di chuyển nhanh (Lỗi)",function()
TPIS()
end)
...
Py:Toggle("Bay",_G.Setting_table.Fly,function(vu)
Fly = vu
...
Py:Slider("Tốc độ ",1,50,16,function(vu)
speedSET = vu
...
Py:Toggle("Tự động bật pvp",_G.Setting_table.Auto_PvP_Turn_On,function(vu)
...
Py:Toggle("Tp đến điểm đã đặt",_G.Setting_table.TP_Position_Spawn,function(vu)
...
SelectedKillPlayer = "..."
local Sl_P = Py:Dropdown("Chọn người chơi",PlayerName,function(vu)
    SelectedKillPlayer = vu
end)
Py:Button("Làm mới",function()
    Sl_P:Clear()
    for i,v in pairs(game.Players:GetChildren()) do  
        Sl_P:Add(v.Name)
    end
end)
Py:Toggle("Quan sát",false,function(value)
    SpectatePlys = value
...
Py:Toggle("Tp Đến người chơi",false,function(value)
...
Py:Toggle("Tp đến người chơi nhanh (dễ kick)",false,function(bool)
                                _G.Teleport = bool
...
Py:Toggle("Ngắm chiêu súng",false,function(vu)
    Aimbot = vu
    if vu then
        for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
            if v:IsA("Tool") then
...
Py:Toggle("Ngắm chiêu",false,function(vu)
    Skillaimbot = vu
    if Skillaimbot then
...
local Boats = Py:Dropdown("Chọn thuyền",BoatsName,function(plys)
_G.SelectB = plys
end)
...
Py:Button("Dịch chuyển thuyền lại mình",function()
...
Py:Toggle("Tp đến thuyền",_G.TPB,function(bool)
_G.TPB = bool       
StopTween(_G.TPB)
...
Py:Toggle("Quan sát thuyền",false,function(bool)
Sp = bool
...
Py:Seperator("Máy chủ")

Py:Button("Sao chép id sv",function()
setclipboard(game.JobId)
end)

Py:Textbox("Dán id Sv Vào",true,function(value)
Server_ID = value
end)


Py:Button("Vào Sv",function()
game.ReplicatedStorage['__ServerBrowser']:InvokeServer('teleport',"'"..Server_ID.."'")
end)

Py:Button("Vào lại Sv",function()
    game:GetService("TeleportService"):Teleport(game.PlaceId, game:GetService("Players").LocalPlayer)
end)

Py:Button("Đổi Sv",function()
    Hop()
end)

Py:Button("Đổi sv ít người",function()
...
Py:Seperator("Mở Giao Diện")
Py:Button("cửa hàng trái",function()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("GetFruits")
    game:GetService("Players").LocalPlayer.PlayerGui.Main.FruitShop.Visible = true
end)

Py:Button("Danh hiệu",function()
local args = {
    [1] = "getTitles"
}
game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer(unpack(args))
...
Py:Button("Haki màu",function()
game.Players.localPlayer.PlayerGui.Main.Colors.Visible = true
end)

Py:Seperator("Kĩ năng")
Py:Toggle("Dịch chuyển vô hạn (inf soru)",_G.Setting_table.Sorunocool,function(vu)
Sorunocool = vu
...
Py:Toggle("Lướt vô hạn",_G.Setting_table.Dodge_No_Cooldown,function(vu)
nododgecool = vu
...
Py:Toggle("Vô hạn nhảy",_G.Setting_table.Infinity_Geppo,function(vu)
noGeppocool = vu
...
Py:Toggle("Vô hạn năng lượng",_G.Setting_table.InfinitsEnergy,function(vu)
InfinitsEnergy = vu
if vu then
    infinitestam()
end
...
Py:Toggle("Đi trên nước",_G.Setting_table.WalkWater,function(vu)
...
spawn(function()
    ...
    Py:Toggle("Chạy nhanh",_G.Setting_table.InfAbility,function(vu)
